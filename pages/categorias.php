...
<head>
  ...
  <link rel="stylesheet" href="../../../css1/arreglosadmin.css">
  <link rel="stylesheet" href="../../../css1/metodos.css">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <li class="nav-item">
                <a href="http://localhost/html/calimamuellesfinal/template/clienetlte/pages/agrearAdmin.php" class="nav-link">
                  <i class="far fa-envelope-open "></i>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-1">
          <button type="button" class="btn info" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap">Agregar </button>
                      ...
                      <div class="col-md-3 col-sm-6 col-12">
                        ...
                        <i class="fa fa-archive" aria-hidden="true" ></i>
                           ...
                           <div class="info-box-content">
                            <span class="info-box-text"  > id:  <?= $listarCategoria['id_categoria'];?></span>
                            <span class="info-box-text"  > nombre: <?= $listarCategoria['nombre_categoria'];?></span>
